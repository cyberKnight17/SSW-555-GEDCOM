    ...
    for person_id in ind:
        ...
        if "BIRT" in person:
            ...
            if recent_date < birth_date and birth_date < datetime.now():
               ...
               result = f'US35:The individual {person["id"]} was recently born.'
               print(result)

    return isThereRecentBirth

ind = {'I01': {'id': 'I01', 'name': 'Joe /Smith/', 'BIRT': '15JUL1960', 'sex': 'M', 'family': 'F23', 'DEAT': '31DEC2013'},
        'I07': {'id': 'I07', 'name': 'Jennifer /Smith/', 'BIRT': '21MAR2019', 'sex': 'F', 'family': 'F23'},
