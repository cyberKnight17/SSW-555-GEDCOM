...
class Us30(unittest.TestCase):
    def test_output_us30(self):
        self.assertEqual(us30(fam,indi),['Sam/Smith/', 'Mary/Smith/', 'Jordan/Smith/', 'Jane/Forrest/', 'Paul/Pierce/', 'Jane/Forrest/', 'Chris/Smith/', 'Fiona/Gibson/'])
        self.assertIn('Sam/Smith/',us30(fam,indi))
        self.assertNotIn('Alice/Smith/',us30(fam,indi))
