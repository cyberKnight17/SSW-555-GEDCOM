import unittest
from userstory37 import us37

fam = {
    'F1': {'fam': 'F1', 'HUSB': 'I2', 'WIFE': 'I3', 'CHIL': {'I1'}},
    'F2': {'fam': 'F2', 'HUSB': 'I4', 'WIFE': 'I5', 'CHIL': {'I6', 'I8', 'I2'}},
    'F3': {'fam': 'F3', 'HUSB': 'I6', 'WIFE': 'I7', 'MARR': '14MAY1985'},
    'F4': {'fam': 'F4', 'HUSB': 'I13', 'WIFE': 'I7', 'MARR': '15MAY2005'},
    'F5': {'fam': 'F5', 'HUSB': 'I8', 'WIFE': 'I10', 'CHIL': {'I11'}, 'MARR': '7MAY2008'},
    'F6': {'fam': 'F6', 'HUSB': 'I8', 'WIFE': 'I9', 'CHIL': {'I12'}, 'MARR': '18APR1994', 'DIV': '14NOV2002'}
}
...
indi = {
    ...
    'I5': {'id': 'I5', 'name': 'Alice/Smith/', 'sex': 'F', 'BIRT': '15JUN1943', 'DEAT': '7APR2019',
           'FAMS': {'F2'}},
    'I6': {'id': 'I6', 'name': 'Sam/Smith/', 'sex': 'M', 'BIRT': '7OCT1965', 'DEAT': '11APR2019', 'FAMS': {'F3'},
           'FAMC': {'F2'}},
...
class Us37(unittest.TestCase):
   def test_output_us37(self):
       self.assertIn('Jordan/Smith/',us37(fam,indi))
       self.assertIn('Jane/Forrest/',us37(fam,indi))
       self.assertEquals(['Jordan/Smith/','Jane/Forrest/'],us37(fam,indi))
