import unittest
import sys, os
path_sprint03 = os.path.dirname(__file__)
print(path_sprint03)
sys.path.append(path_sprint03)
import us35,us24
...
ind1 = {'I01': {'id': 'I01', 'name': 'Joe /Smith/', 'BIRT': '15 JUL 1960', 'sex': 'M', 'family': 'F23', 'DEAT': '31 DEC 2013'},
...
fam1 = {'F23': {'fam': 'F23', 'MARR': '14 FEB 1980', 'HUSB': 'I01', 'WIFE': 'I07', 'CHIL': ['I19', 'I26', 'I30', 'I32', 'I43']},
         'F16': {'fam': 'F16', 'MARR': '12 DEC 2007','HUSB': 'I45', 'WIFE': 'I44'},
         'F12': {'fam': 'F12', 'MARR': '12 DEC 2008','DIV':'12 DEC 2001','HUSB': 'I32', 'WIFE': 'I30'}}



class Test_us3524(unittest.TestCase):
    
    def test_us35(self):
        self.assertTrue(us35.print_recent_births(ind1, fam1))
        print('Done')

    def test_us24(self):
        self.assertFalse(us24.unique_families_by_spouses(ind,fam))
