...
class Us39(unittest.TestCase):
   def test_output_us39(self):
       self.assertIn('I13 Paul/Pierce/ I7 Jane/Forrest/',us39(fam,indi))
       self.assertIn('I8 Chris/Smith/ I10 Fiona/Gibson/',us39(fam,indi))
       self.assertEqual(['I13 Paul/Pierce/ I7 Jane/Forrest/','I8 Chris/Smith/ I10 Fiona/Gibson/'],us39(fam,indi))
